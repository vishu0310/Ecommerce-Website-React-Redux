      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-x-8 gap-y-10">
          <div className="lg:col-span-3 py-12">
            <form className='bg-white px-5 mt-0 ' >
                ...
                <div className="border-b border-gray-900/10 pb-12">
                  ...
                  <ul role="list" className="divide-y divide-gray-100">
                    {addresses.map((address) => (
                      <li key={address.phone} className="flex justify-between gap-x-6 py-5 px-5 border-solid border-2 border-gray-200">
                        ...
                        <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                          ...
                          <p className="text-sm leading-6 text-gray-500">{address.city} , {address.state}</p>
                        </div>
                      </li>
                    ))}
                  </ul>
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto  bg-white max-w-7xl px-0 sm:px-6 lg:px-4">
              <div className='mt-12'>
                <h1 className="text-3xl my-5 mb-3 font-bold tracking-tight py-5 text-gray-900">
                  Cart
                </h1>
